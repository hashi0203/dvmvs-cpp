...
class Config:
    ...
    # test_dataset_name = "hololens"
    # test_dataset_name = "chess-seq-01"
    # test_dataset_name = "chess-seq-02"
    # test_dataset_name = "fire-seq-01"
    # test_dataset_name = "fire-seq-02"
    # test_dataset_name = "heads-seq-02"
    # test_dataset_name = "office-seq-01"
    # test_dataset_name = "office-seq-03"
    # test_dataset_name = "pumpkin-seq-03"
    # test_dataset_name = "pumpkin-seq-06"
    # test_dataset_name = "redkitchen-seq-01"
    # test_dataset_name = "redkitchen-seq-07"
    # test_dataset_name = "stairs-seq-02"
    # test_dataset_name = "stairs-seq-06"

    # test_dataset_name = "chess-seq-03"
    # test_dataset_name = "fire-seq-03"
    # test_dataset_name = "fire-seq-04"
    # test_dataset_name = "heads-seq-01"
    # test_dataset_name = "office-seq-02"
    # test_dataset_name = "pumpkin-seq-01"
    # test_dataset_name = "redkitchen-seq-03"
    # test_dataset_name = "stairs-seq-01"
    # test_online_scene_path = "/home/nhsmt1123/master-thesis/deep-video-mvs/data/7scenes/%s" % test_dataset_name
